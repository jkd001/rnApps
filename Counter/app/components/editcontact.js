...
class EditContact extends Component {
    ...
    onSave= () => {
        ...
        let {item} = this.props;
        //const URL = ConstInfo.host+"/post/api/1.2/contacts/"+item;
        const URL = ConstInfo.host + "/put/api/1.1/"+ConstInfo.contactsname+"/" + item;
        alert(URL);
        let formData = new FormData();
    ...
    render() {
        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <TouchableHighlight style={styles.button} onPress={actions.gotoall} underlayColor='#99d9f4'>
